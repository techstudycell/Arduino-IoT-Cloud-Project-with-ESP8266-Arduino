/**********************************************************************************
 *  TITLE: WiFi (Arduino IoT Cloud) + IR + Manual Button (momentary) control 4 Relays with DHT11 Arduino EEPROM
 ...
 *  IRremote 3.6.1 Library:  https://github.com/Arduino-IRremote/Arduino-IRremote
 *  AceButton 1.9.2 Library: https://github.com/bxparks/AceButton
 *  Arduino-timer 2.3.1 Library: https://github.com/contrem/arduino-timer
 *  DHT Sensor 1.4.4 Library: https://github.com/adafruit/DHT-sensor-library
 **********************************************************************************/
...
#define DHTPIN      A1  //A1  pin connected with DHT
...
void wifi_control()
{
  if(mySerial.available()) {
    ...
    Serial.println(bt_data);
        ...
        delay(200);
        pinStatus = String(!digitalRead(RelayPin1)) + String(!digitalRead(RelayPin2)) + String(!digitalRead(RelayPin3)) + String(!digitalRead(RelayPin4))+ String(temperature1);
